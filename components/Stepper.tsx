...
export default function Stepper({
  ...
  // The final button acts as a CTA instead of collapsing the content away.
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: '100%', backgroundColor: '#0050bd' }
  };

  return (
    <div className="relative mx-2 h-px flex-1 overflow-hidden bg-ink/10">
      <motion.div
